...
import webbrowser
import \
    ssl  # This module provides access to Transport Layer Security (often known as “Secure Sockets Layer”) encryption and peer authentication facilities for network sockets, both client-side  and server-side.  This module uses the OpenSSL library
import \
...
def respond(voice_data):
    ...
    if there_exists(['hey', 'hi', 'hola', 'hello', 'wassup', ]):
        greetings = ["Hi sir, What we gonna do today?" + person_obj.name,
                     "Hi sir, what are we doing today?" + person_obj.name,
                     "Hi sir, How can i help you?" + person_obj.name]
    ...
    if there_exists(["what is your name", "what's your name", "tell me your name"]):
        if person_obj.name:
            ...
            engine_speak(
                "I dont know my sir,please assighn my name by saying command your name should be ,,,,and sir will be priviledged to know your name ")
    ...
    if there_exists(["are you in a relationship", "are you in love", "do you have a boyfriend"]):
        engine_speak("Yes but I wish he would stop cheating on me, it's really complicated?")



    # for exit
    if there_exists(["exit", "goodbye", "quit", "take some rest bro"]):
        engine_speak("It was great talking to you, well goodbye")
        exit()
